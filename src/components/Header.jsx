          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-center md:text-left">
                Rumah Bapak Sabar, Kampung Rawasari RT 01/RW01, Distrik Malind,
      ...
      >
        <div className="container-custom">
          <div className="flex items-center justify-between py-4">
                    ...
                    <>
                      <button
                        className={`font-medium transition-colors hover:text-primary ${
                          isActivePath("/nasi-box") ||
                          isActivePath("/menu-box-syukuran")
                            ? "text-primary"
                            : "text-gray-700"
                        }`}
                      >
            ...
            {/* CTA Button */}
            <Link to="/galeri" className="hidden lg:block btn-primary">
              Lihat Menu
            </Link>
            ...
            >
              <div className="container-custom py-4">
                <nav className="flex flex-col gap-4">
                  ...
                  <Link to="/galeri" className="btn-primary text-center">
                    Lihat Menu
                  </Link>
                </nav>
              </div>
