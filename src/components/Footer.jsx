    ...
    <footer className="bg-brown-800 text-white">
      <div className="container-custom py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-2 lg:col-span-5">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              CateringKu merupakan penyedia jasa catering terpercaya yang
              berbasis di Kota Yogyakarta dan sekitarnya. Dengan pengalaman
              lebih dari satu tahun dalam industri, kami menawarkan layanan
              catering harian untuk karyawan serta catering untuk berbagai acara
              seperti event, seminar, rapat, dan gathering.
            </p>
        ...
        <div className="border-t border-brown-700 mt-8 pt-8 text-center text-sm">
          <p className="text-gray-300">
            Copyright © {currentYear} CateringKu Service. All rights reserved.
            Developed with ❤️ by{" "}
            <span className="text-primary font-semibold">JMV</span>
          </p>
        </div>
      </div>
    </footer>
