          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h1 className="text-5xl font-bold text-brown-800 mb-6">
                Sajian Berkelas Untuk
                <br />
                <span className="text-primary">Segala Momen Istimewa</span>
              </h1>
              <p className="text-gray-700 mb-6 leading-relaxed">
                Kencana Catering menawarkan berbagai paket catering yang ideal
                untuk acara kantor, seminar, gathering, dan acara lainnya.
                Dengan menu yang lezat dan harga yang kompetitif, kami siap
                memberikan pelayanan terbaik untuk acara Anda. Dari rapat hingga
                tingkat syukuran, kami menawarkan berbagai menu yang dapat
                disesuaikan dengan kebutuhan acara Anda. Biarkan kami mengurus
                kebutuhan catering acara Anda sehingga Anda dapat fokus pada
                hal-hal yang lebih penting. Nikmati pelayanan catering yang tak
                terlupakan dari Kencana Catering dan buat setiap peristiwa Anda
                berkesan!
              </p>
            </motion.div>
        ...
        <div className="container-custom">
          ...
          >
            <h2 className="text-3xl font-bold text-brown-800 mb-6">
              Keterangan Paket Catering
            </h2>
            <div className="space-y-3 text-gray-700">
              <p>
                • Menu harian berubah, atau bisa meng dengan kebutuhan yang ada
              </p>
