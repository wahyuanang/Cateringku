...
const Home = () => {
  const features = [
    {
      ...
      description:
        "Kami menggunakan bahan-bahan segar terbaik untuk setiap hidangan yang kami sajikan.",
    },
    {
      icon: <FaUsers className="text-4xl" />,
      title: "Pelayanan Profesional",
      description:
        "Didukung oleh tim berpengalaman, kami siap melayani kebutuhan catering Anda dengan profesional dan ramah.",
    },
    {
      icon: <FaDollarSign className="text-4xl" />,
      title: "Pemesanan Mudah",
      description:
        "Proses pemesanan yang mudah dan transparan, dengan opsi pembayaran fleksibel.",
    },
    {
      icon: <FaStar className="text-4xl" />,
      title: "Catering Berpengalaman",
      description:
        "Dengan lebih dari 1 tahun pengalaman, kami siap membantu berbagai acara Anda dengan sempurna.",
    },
  ];
  ...
  const packages = [
    {
      image:
        "https://images.unsplash.com/photo-1606491956689-2ea866880c84?w=500&h=500&fit=crop&q=80",
      title: "Menu Nasi Box",
    ...
    {
      image:
        "https://images.unsplash.com/photo-1626074353765-517a681e40be?w=500&h=500&fit=crop&q=80",
    ...
    {
      image:
        "https://images.unsplash.com/photo-1555244162-803834f70033?w=500&h=500&fit=crop&q=80",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-gray-700 mb-8 leading-relaxed max-w-xl">
                Jelajahi hidangan kami yang lezat disediakan dengan cinta dan
                perhatian untuk setiap detail. Dengan bahan-bahan segar dan
                berkualitas tinggi yang dipilih dengan hati-hati untuk
                menciptakan rasa yang sempurna. Biarkan kami mengurus acara Anda
                dengan sempurna!
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-gray-700 mb-6 leading-relaxed">
                CateringKu adalah penyedia jasa catering terpercaya yang
                berbasis di Papua Selatan. Dengan pengalaman dalam industri
                kuliner, kami menawarkan layanan catering harian untuk karyawan
                serta catering untuk berbagai acara seperti event, seminar,
                rapat, dan gathering.
              </p>
              <p className="text-gray-700 mb-6 leading-relaxed">
                Dengan spesialisasi dalam pengolahan catering untuk berbagai
                acara seperti pernikahan, syukuran, dan acara khusus lainnya
                dengan menu Nasi Box, Box Syukuran, dan Tumpeng, kami siap
                memberikan pelayanan terbaik untuk kebutuhan acara Anda. Selalu
                mengedepankan kualitas dan kepuasan pelanggan, kami berkomitmen
                tinggi untuk memberikan layanan profesional yang sempurna.
              </p>
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              ...
              dengan kebutuhan acara Anda, dari acara kecil hingga besar dengan
              menu yang lezat dan harga yang terjangkau.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-cream">
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Setiap hidangan kami adalah karya seni kuliner yang dibuat dengan
              dedikasi dan keahlian tinggi untuk menghadirkan pengalaman kuliner
              yang tak terlupakan bagi setiap tamu Anda.
            </p>
          </motion.div>
