...
const Kontak = () => {
  ...
  const handleSubmit = (e) => {
    ...
    window.open(`https://wa.me/6281284216397?text=${whatsappMessage}`, '_blank');
  };
        ...
        <div className="container-custom text-center">
          ...
          >
            ...
            <h1 className="text-5xl font-bold text-brown-800 mb-6">
              Siap untuk Memesan atau<br />Bertanya Lebih Lanjut?
            </h1>
            <p className="text-gray-700 max-w-3xl mx-auto leading-relaxed">
              Kami siap membantu Anda dalam setiap tahap perencanaan acara Anda! Jangan ragu untuk menghubungi tim CateringKu sekarang. Dengan pengalaman dalam industri kuliner, kami siap membantu Anda dalam menjawab pertanyaan, permintaan khusus, atau melakukan pemesanan.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-3xl font-bold text-brown-800 mb-8">Hubungi Kami</h2>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4 p-6 bg-cream rounded-2xl">
                  ...
                  <div>
                    <h3 className="font-bold text-brown-800 mb-2">No. Telepon</h3>
                    <a href="tel:+6281284216397" className="text-gray-700 hover:text-primary transition-colors">
                      +62 812-8421-6397
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 p-6 bg-cream rounded-2xl">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@kencanacatering.com" className="text-gray-700 hover:text-primary transition-colors">
            ...
            >
              <div className="bg-gradient-to-br from-primary/10 to-secondary/10 p-8 rounded-3xl">
                <h2 className="text-3xl font-bold text-brown-800 mb-6">Kirim Pesan</h2>
