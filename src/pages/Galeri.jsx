...
const Galeri = () => {
  ...
  const galleryImages = [
    {
      id: 1,
      url: "https://images.unsplash.com/photo-1563379926898-05f4575a45d8?w=800&h=800&fit=crop",
      title: "Paket Catering 1",
    },
    {
      id: 2,
      url: "https://images.unsplash.com/photo-1540189549336-e6e99c3679fe?w=800&h=800&fit=crop",
      title: "Nasi Box Spesial",
    },
    {
      id: 3,
      url: "https://pondokescendol.com/wp-content/uploads/2023/02/tumpeng.png",
      title: "Tumpeng Tradisional",
    },
    {
      id: 4,
      url: "https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=800&h=800&fit=crop",
    ...
    },
    {
      id: 6,
      url: "https://pondokescendol.com/wp-content/uploads/2023/02/tumpeng.png",
      title: "Tumpeng Kuning",
    },
    {
      id: 7,
      url: "https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=800&h=800&fit=crop",
      title: "Paket Catering Premium",
    },
    {
      id: 8,
      url: "https://images.unsplash.com/photo-1555244162-803834f70033?w=800&h=800&fit=crop",
      title: "Buffet Catering",
    },
    {
      id: 9,
      url: "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=800&h=800&fit=crop",
    ...
    {
      id: 11,
      url: "https://images.unsplash.com/photo-1476224203421-9ac39bcb3327?w=800&h=800&fit=crop",
      title: "Dessert Box",
    },
    {
      id: 12,
      url: "https://images.unsplash.com/photo-1565958011703-44f9829ba187?w=800&h=800&fit=crop",
      title: "Snack Box",
    },
  ];
      ...
      <section className="py-12 bg-white">
        <div className="container-custom">
          ...
          <div className="flex justify-center items-center gap-2 mt-12">
            ...
            <button className="px-4 py-2 bg-white text-gray-700 rounded-lg hover:bg-primary hover:text-white transition-colors">
              2
            </button>
            <button className="px-4 py-2 bg-white text-gray-700 rounded-lg hover:bg-primary hover:text-white transition-colors">
              3
